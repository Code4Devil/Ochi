...
function Footer() {
  return (
    <div data-scroll data-scroll-speed='1' className='w-full h-screen p-20 pt-40 flex bg-zinc-900'>
        <div className='w-1/2 h-full flex flex-col font-[founders] justify-between '>

<div className=' '>
<h1 className='text-9xl uppercase leading- font-semibold -mb-8'>Eye-</h1>
<h1 className='text-9xl uppercase leading- font-semibold -mb-8'>opening</h1>
</div>
...
<svg width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='w-1/2'>
         <div className='w-full h-full flex flex-col font-[founders] justify-between items-end '>

            <div className=' '>
            <h1 className='text-9xl uppercase leading- font-semibold '>Presentations</h1>
            ...
            <div className='flex flex-col gap-5 items-end justify-end h-full'>
            {["Facebook","Instagram","Twitter"].map((items,index)=>{
                return <div className='w-'>
                    <a className='text-white text-4xl' key={index} href="">{items}</a>
                </div>
            })}
            </div>
